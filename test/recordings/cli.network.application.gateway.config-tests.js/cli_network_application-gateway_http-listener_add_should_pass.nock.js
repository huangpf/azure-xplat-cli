...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': '21bef58e9a61724ea8981371b8329910',
  date: 'Mon, 29 Feb 2016 11:51:03 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
.post('/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/services/networking/ApplicationGateways/CliTestAppGate/configuration?api-version=2015-04-01', '*')
  .reply(202, "<GatewayOperationAsyncResponse xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>f765dfd3-f177-473f-a885-a4a07db0191e</ID></GatewayOperationAsyncResponse>", { 'cache-control': 'no-cache',
  'content-length': '210',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.323 (rd_rdfe_stable.160224-0707) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': 'e60bcfc641897682990363efefded3d1',
  date: 'Mon, 29 Feb 2016 11:51:09 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/services/networking/operation/f765dfd3-f177-473f-a885-a4a07db0191e')
  .reply(200, "<GatewayOperation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><Data/><HealthStatus/><HttpStatusCode>OK</HttpStatusCode><ID>f765dfd3-f177-473f-a885-a4a07db0191e</ID><OperationCompletedTime>2016-02-29T11:51:11.5706163</OperationCompletedTime><OperationStartedTime>2016-02-29T11:51:09.1752645</OperationStartedTime><Status>Successful</Status></GatewayOperation>", { 'cache-control': 'no-cache',
  'content-length': '416',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.323 (rd_rdfe_stable.160224-0707) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': '1e91a71e45b27900aaa69f7fe916f387',
  date: 'Mon, 29 Feb 2016 11:51:40 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': 'e80b11e2078c78ada06a5975bb555b96',
  date: 'Mon, 29 Feb 2016 11:51:41 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
