...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': '86405f4c2f3c7b8ea74ea18113b45506',
  date: 'Mon, 29 Feb 2016 11:54:56 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
.post('/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/services/networking/ApplicationGateways/CliTestAppGate/configuration?api-version=2015-04-01', '*')
  .reply(202, "<GatewayOperationAsyncResponse xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>e7f16eb6-2e26-41a9-adb7-3bf9f0ad9cb9</ID></GatewayOperationAsyncResponse>", { 'cache-control': 'no-cache',
  'content-length': '210',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.323 (rd_rdfe_stable.160224-0707) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': 'e47c765098e972c68826bd2b96976f28',
  date: 'Mon, 29 Feb 2016 11:54:59 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/services/networking/operation/e7f16eb6-2e26-41a9-adb7-3bf9f0ad9cb9')
  .reply(200, "<GatewayOperation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><Data/><HealthStatus/><HttpStatusCode>OK</HttpStatusCode><ID>e7f16eb6-2e26-41a9-adb7-3bf9f0ad9cb9</ID><OperationCompletedTime>2016-02-29T11:55:00.8513887</OperationCompletedTime><OperationStartedTime>2016-02-29T11:54:59.474668</OperationStartedTime><Status>Successful</Status></GatewayOperation>", { 'cache-control': 'no-cache',
  'content-length': '415',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.323 (rd_rdfe_stable.160224-0707) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': '2cd89fa1a32972faa461eb4c55cbe285',
  date: 'Mon, 29 Feb 2016 11:55:30 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
