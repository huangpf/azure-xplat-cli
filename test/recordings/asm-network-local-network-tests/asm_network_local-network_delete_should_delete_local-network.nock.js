...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': '5ab612fadeceb9728c705100a3cd6242',
  date: 'Thu, 25 Jun 2015 13:34:46 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
.put('/bfb5e0bf-124b-4d0c-9352-7c0a9f4d9948/services/networking/media', '*')
  ...
  server: '1.0.6198.243 (rd_rdfe_stable.150618-1025) Microsoft-HTTPAPI/2.0 Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'usnorth2',
  'x-ms-request-id': 'e3c2bfc6d144b163984965df03d64d5d',
  date: 'Thu, 25 Jun 2015 13:34:49 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/bfb5e0bf-124b-4d0c-9352-7c0a9f4d9948/operations/e3c2bfc6d144b163984965df03d64d5d')
  .reply(200, "<Operation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>e3c2bfc6-d144-b163-9849-65df03d64d5d</ID><Status>Succeeded</Status><HttpStatusCode>200</HttpStatusCode></Operation>", { 'cache-control': 'no-cache',
  'content-length': '232',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.243 (rd_rdfe_stable.150618-1025) Microsoft-HTTPAPI/2.0 Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'usnorth2',
  'x-ms-request-id': '7831eeefd812b797b64c624a50e59704',
  date: 'Thu, 25 Jun 2015 13:35:21 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
