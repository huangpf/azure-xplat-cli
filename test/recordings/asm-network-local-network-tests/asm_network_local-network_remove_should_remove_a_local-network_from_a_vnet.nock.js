...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': '14bb6913b6f8b90983ae8ce93fd1484a',
  date: 'Thu, 25 Jun 2015 13:33:21 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
.put('/bfb5e0bf-124b-4d0c-9352-7c0a9f4d9948/services/networking/media', '*')
  ...
  server: '1.0.6198.243 (rd_rdfe_stable.150618-1025) Microsoft-HTTPAPI/2.0 Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'usnorth2',
  'x-ms-request-id': '64b1ec131422ba848da9956d8e75c7c0',
  date: 'Thu, 25 Jun 2015 13:33:25 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/bfb5e0bf-124b-4d0c-9352-7c0a9f4d9948/operations/64b1ec131422ba848da9956d8e75c7c0')
  .reply(200, "<Operation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>64b1ec13-1422-ba84-8da9-956d8e75c7c0</ID><Status>Succeeded</Status><HttpStatusCode>200</HttpStatusCode></Operation>", { 'cache-control': 'no-cache',
  'content-length': '232',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.243 (rd_rdfe_stable.150618-1025) Microsoft-HTTPAPI/2.0 Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'usnorth2',
  'x-ms-request-id': '804424949751bd3187d962464ab9e185',
  date: 'Thu, 25 Jun 2015 13:33:57 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
