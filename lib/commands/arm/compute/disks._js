...
azure disk config creation-data set
--parameter-file $f
--parse
...
azure disk config creation-data delete
--parameter-file $f
--create-option
--storage-account-id
--image-reference
...
azure disk config image-reference set
--parameter-file $f
--parse
--id $id
--lun $lun

azure disk config image-reference delete
--parameter-file $f
--id
--lun

azure disk config encryption-settings set
--parameter-file $f
--parse
--enabled $enabled
...
azure disk config encryption-settings delete
--parameter-file $f
--enabled
--disk-encryption-key
--key-encryption-key

azure disk config disk-encryption-key set
--parameter-file $f
--parse
--source-vault $sourceVault
--secret-url $secretUrl

azure disk config disk-encryption-key delete
--parameter-file $f
--source-vault
--secret-url

azure disk config source-vault set
--parameter-file $f
--parse
--id $id

azure disk config source-vault delete
--parameter-file $f
--id

azure disk config key-encryption-key set
--parameter-file $f
--parse
--source-vault $sourceVault
--key-url $keyUrl

azure disk config key-encryption-key delete
--parameter-file $f
--source-vault
--key-url
...
azure disk config generate 
--parameter-file $f

azure disk config patch 
--parameter-file $f
...
azure disk grant-access-parameters grant-access-data set
--parameter-file $f
--parse
--access $access
--duration-in-seconds $durationInSeconds

azure disk grant-access-parameters grant-access-data delete
--parameter-file $f
--access
--duration-in-seconds

azure disk grant-access 
--resource-group $p0
--name $p1
...
azure disk list-by-resource-group 
--resource-group $p0

azure disk revoke-access 
--resource-group $p0
--name $p1

azure disk update-parameters disk-update set
--parameter-file $f
--parse
--account-type $accountType
--os-type $osType
...
azure disk update-parameters disk-update delete
--parameter-file $f
--account-type
--os-type
--creation-data
...
azure disk update-parameters creation-data set
--parameter-file $f
--parse
--create-option $createOption
--storage-account-id $storageAccountId
...
azure disk update-parameters creation-data delete
--parameter-file $f
--create-option
--storage-account-id
--image-reference
...
azure disk update-parameters image-reference set
--parameter-file $f
--parse
--id $id
--lun $lun

azure disk update-parameters image-reference delete
--parameter-file $f
--id
--lun

azure disk update-parameters encryption-settings set
--parameter-file $f
--parse
--enabled $enabled
--disk-encryption-key $diskEncryptionKey
...
azure disk update-parameters encryption-settings delete
--parameter-file $f
--enabled
--disk-encryption-key
--key-encryption-key

azure disk update-parameters disk-encryption-key set
--parameter-file $f
--parse
--source-vault $sourceVault
--secret-url $secretUrl

azure disk update-parameters disk-encryption-key delete
--parameter-file $f
--source-vault
--secret-url

azure disk update-parameters source-vault set
--parameter-file $f
--parse
--id $id

azure disk update-parameters source-vault delete
--parameter-file $f
--id

azure disk update-parameters key-encryption-key set
--parameter-file $f
--parse
--source-vault $sourceVault
--key-url $keyUrl

azure disk update-parameters key-encryption-key delete
--parameter-file $f
--source-vault
--key-url
...
azure disk update-parameters generate 
--parameter-file $f

azure disk update-parameters patch 
--parameter-file $f
...
*/
  var disksCreateOrUpdate = cli.category('disk')
  ...
  //config set disk
  var catparametersCreateOrUpdateDisksDisk0 = cli.category('disk');
  ...
  .description($('Commands to configure disk of disk in config file.'));
  ...
  //config delete disk
  var catparametersCreateOrUpdateDisksDisk1 = cli.category('disk');
  ...
  var catparametersCreateOrUpdateDisksCreationData0 = cli.category('disk');
  var parametersCreateOrUpdateDisksCreationData0 = catparametersCreateOrUpdateDisksCreationData0.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersCreateOrUpdateDisksCreationData0 = parametersCreateOrUpdateDisksCreationData0.category('creation-data')
  .description($('Commands to configure creation-data of disk in config file.'));
  setparametersCreateOrUpdateDisksCreationData0.command('set')
  ...
  var catparametersCreateOrUpdateDisksCreationData1 = cli.category('disk');
  var parametersCreateOrUpdateDisksCreationData1 = catparametersCreateOrUpdateDisksCreationData1.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersCreateOrUpdateDisksCreationData1 = parametersCreateOrUpdateDisksCreationData1.category('creation-data')
  .description($('Commands to configure creation-data of disk in config file.'));
  deleteparametersCreateOrUpdateDisksCreationData1.command('delete')
  ...
  var catparametersCreateOrUpdateDisksImageReference0 = cli.category('disk');
  var parametersCreateOrUpdateDisksImageReference0 = catparametersCreateOrUpdateDisksImageReference0.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersCreateOrUpdateDisksImageReference0 = parametersCreateOrUpdateDisksImageReference0.category('image-reference')
  .description($('Commands to configure image-reference of disk in config file.'));
  setparametersCreateOrUpdateDisksImageReference0.command('set')
  ...
  var catparametersCreateOrUpdateDisksImageReference1 = cli.category('disk');
  var parametersCreateOrUpdateDisksImageReference1 = catparametersCreateOrUpdateDisksImageReference1.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersCreateOrUpdateDisksImageReference1 = parametersCreateOrUpdateDisksImageReference1.category('image-reference')
  .description($('Commands to configure image-reference of disk in config file.'));
  deleteparametersCreateOrUpdateDisksImageReference1.command('delete')
  ...
  var catparametersCreateOrUpdateDisksEncryptionSettings0 = cli.category('disk');
  var parametersCreateOrUpdateDisksEncryptionSettings0 = catparametersCreateOrUpdateDisksEncryptionSettings0.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersCreateOrUpdateDisksEncryptionSettings0 = parametersCreateOrUpdateDisksEncryptionSettings0.category('encryption-settings')
  .description($('Commands to configure encryption-settings of disk in config file.'));
  setparametersCreateOrUpdateDisksEncryptionSettings0.command('set')
  ...
  var catparametersCreateOrUpdateDisksEncryptionSettings1 = cli.category('disk');
  var parametersCreateOrUpdateDisksEncryptionSettings1 = catparametersCreateOrUpdateDisksEncryptionSettings1.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersCreateOrUpdateDisksEncryptionSettings1 = parametersCreateOrUpdateDisksEncryptionSettings1.category('encryption-settings')
  .description($('Commands to configure encryption-settings of disk in config file.'));
  deleteparametersCreateOrUpdateDisksEncryptionSettings1.command('delete')
  ...
  var catparametersCreateOrUpdateDisksDiskEncryptionKey0 = cli.category('disk');
  var parametersCreateOrUpdateDisksDiskEncryptionKey0 = catparametersCreateOrUpdateDisksDiskEncryptionKey0.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersCreateOrUpdateDisksDiskEncryptionKey0 = parametersCreateOrUpdateDisksDiskEncryptionKey0.category('disk-encryption-key')
  .description($('Commands to configure disk-encryption-key of disk in config file.'));
  setparametersCreateOrUpdateDisksDiskEncryptionKey0.command('set')
  ...
  var catparametersCreateOrUpdateDisksDiskEncryptionKey1 = cli.category('disk');
  var parametersCreateOrUpdateDisksDiskEncryptionKey1 = catparametersCreateOrUpdateDisksDiskEncryptionKey1.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersCreateOrUpdateDisksDiskEncryptionKey1 = parametersCreateOrUpdateDisksDiskEncryptionKey1.category('disk-encryption-key')
  .description($('Commands to configure disk-encryption-key of disk in config file.'));
  deleteparametersCreateOrUpdateDisksDiskEncryptionKey1.command('delete')
  ...
  var catparametersCreateOrUpdateDisksSourceVault0 = cli.category('disk');
  var parametersCreateOrUpdateDisksSourceVault0 = catparametersCreateOrUpdateDisksSourceVault0.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersCreateOrUpdateDisksSourceVault0 = parametersCreateOrUpdateDisksSourceVault0.category('source-vault')
  .description($('Commands to configure source-vault of disk in config file.'));
  setparametersCreateOrUpdateDisksSourceVault0.command('set')
  ...
  var catparametersCreateOrUpdateDisksSourceVault1 = cli.category('disk');
  var parametersCreateOrUpdateDisksSourceVault1 = catparametersCreateOrUpdateDisksSourceVault1.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersCreateOrUpdateDisksSourceVault1 = parametersCreateOrUpdateDisksSourceVault1.category('source-vault')
  .description($('Commands to configure source-vault of disk in config file.'));
  deleteparametersCreateOrUpdateDisksSourceVault1.command('delete')
  ...
  var catparametersCreateOrUpdateDisksKeyEncryptionKey0 = cli.category('disk');
  var parametersCreateOrUpdateDisksKeyEncryptionKey0 = catparametersCreateOrUpdateDisksKeyEncryptionKey0.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersCreateOrUpdateDisksKeyEncryptionKey0 = parametersCreateOrUpdateDisksKeyEncryptionKey0.category('key-encryption-key')
  .description($('Commands to configure key-encryption-key of disk in config file.'));
  setparametersCreateOrUpdateDisksKeyEncryptionKey0.command('set')
  ...
  var catparametersCreateOrUpdateDisksKeyEncryptionKey1 = cli.category('disk');
  var parametersCreateOrUpdateDisksKeyEncryptionKey1 = catparametersCreateOrUpdateDisksKeyEncryptionKey1.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersCreateOrUpdateDisksKeyEncryptionKey1 = parametersCreateOrUpdateDisksKeyEncryptionKey1.category('key-encryption-key')
  .description($('Commands to configure key-encryption-key of disk in config file.'));
  deleteparametersCreateOrUpdateDisksKeyEncryptionKey1.command('delete')
...
/*
  ...
  --name
*/
  var disksDelete = cli.category('disk')
  .description($('Commands to manage your disks.  '));
...
/*
  ...
  --name
*/
  var disksGet = cli.category('disk')
  .description($('Commands to manage your disks.  '));
...
*/
  var disksGrantAccess = cli.category('disk')
  .description($('Commands to manage your disks.  '));
...
/*
  Disks List
*/
  var disksList = cli.category('disk')
  .description($('Commands to manage your disks.  '));
  disksList.command('list')
  ...
  .execute(function(options, _) {
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.disks.list(_);
    var nextPageLink = result.nextLink;
    while (nextPageLink) {
      var pageResult = computeManagementClient.disks.listNext(nextPageLink, _);
...
/*
  ...
  --resource-group
*/
  var disksListByResourceGroup = cli.category('disk')
  .description($('Commands to manage your disks.  '));
  disksListByResourceGroup.command('list-by-resource-group [resource-group]')
  ...
  .execute(function(resourceGroup, options, _) {
    ...
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.disks.listByResourceGroup(resourceGroup, _);
    var nextPageLink = result.nextLink;
    while (nextPageLink) {
...
/*
  ...
  --name
*/
  var disksRevokeAccess = cli.category('disk')
  .description($('Commands to manage your disks.  '));
...
*/
  var disksUpdate = cli.category('disk')
  .description($('Commands to manage your disks.  '));
  ...
  var catparametersUpdateDisksDiskUpdate0 = cli.category('disk');
  ...
  .description($('Commands to configure disk-update of disk in update-parameters file.'));
  ...
  var catparametersUpdateDisksDiskUpdate1 = cli.category('disk');
  ...
  var catparametersUpdateDisksCreationData0 = cli.category('disk');
  var parametersUpdateDisksCreationData0 = catparametersUpdateDisksCreationData0.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersUpdateDisksCreationData0 = parametersUpdateDisksCreationData0.category('creation-data')
  .description($('Commands to configure creation-data of disk in update-parameters file.'));
  setparametersUpdateDisksCreationData0.command('set')
  ...
  var catparametersUpdateDisksCreationData1 = cli.category('disk');
  var parametersUpdateDisksCreationData1 = catparametersUpdateDisksCreationData1.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersUpdateDisksCreationData1 = parametersUpdateDisksCreationData1.category('creation-data')
  .description($('Commands to configure creation-data of disk in update-parameters file.'));
  deleteparametersUpdateDisksCreationData1.command('delete')
  ...
  var catparametersUpdateDisksImageReference0 = cli.category('disk');
  var parametersUpdateDisksImageReference0 = catparametersUpdateDisksImageReference0.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersUpdateDisksImageReference0 = parametersUpdateDisksImageReference0.category('image-reference')
  .description($('Commands to configure image-reference of disk in update-parameters file.'));
  setparametersUpdateDisksImageReference0.command('set')
  ...
  var catparametersUpdateDisksImageReference1 = cli.category('disk');
  var parametersUpdateDisksImageReference1 = catparametersUpdateDisksImageReference1.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersUpdateDisksImageReference1 = parametersUpdateDisksImageReference1.category('image-reference')
  .description($('Commands to configure image-reference of disk in update-parameters file.'));
  deleteparametersUpdateDisksImageReference1.command('delete')
  ...
  var catparametersUpdateDisksEncryptionSettings0 = cli.category('disk');
  var parametersUpdateDisksEncryptionSettings0 = catparametersUpdateDisksEncryptionSettings0.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersUpdateDisksEncryptionSettings0 = parametersUpdateDisksEncryptionSettings0.category('encryption-settings')
  .description($('Commands to configure encryption-settings of disk in update-parameters file.'));
  setparametersUpdateDisksEncryptionSettings0.command('set')
  ...
  var catparametersUpdateDisksEncryptionSettings1 = cli.category('disk');
  var parametersUpdateDisksEncryptionSettings1 = catparametersUpdateDisksEncryptionSettings1.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersUpdateDisksEncryptionSettings1 = parametersUpdateDisksEncryptionSettings1.category('encryption-settings')
  .description($('Commands to configure encryption-settings of disk in update-parameters file.'));
  deleteparametersUpdateDisksEncryptionSettings1.command('delete')
  ...
  var catparametersUpdateDisksDiskEncryptionKey0 = cli.category('disk');
  var parametersUpdateDisksDiskEncryptionKey0 = catparametersUpdateDisksDiskEncryptionKey0.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersUpdateDisksDiskEncryptionKey0 = parametersUpdateDisksDiskEncryptionKey0.category('disk-encryption-key')
  .description($('Commands to configure disk-encryption-key of disk in update-parameters file.'));
  setparametersUpdateDisksDiskEncryptionKey0.command('set')
  ...
  var catparametersUpdateDisksDiskEncryptionKey1 = cli.category('disk');
  var parametersUpdateDisksDiskEncryptionKey1 = catparametersUpdateDisksDiskEncryptionKey1.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersUpdateDisksDiskEncryptionKey1 = parametersUpdateDisksDiskEncryptionKey1.category('disk-encryption-key')
  .description($('Commands to configure disk-encryption-key of disk in update-parameters file.'));
  deleteparametersUpdateDisksDiskEncryptionKey1.command('delete')
  ...
  var catparametersUpdateDisksSourceVault0 = cli.category('disk');
  var parametersUpdateDisksSourceVault0 = catparametersUpdateDisksSourceVault0.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersUpdateDisksSourceVault0 = parametersUpdateDisksSourceVault0.category('source-vault')
  .description($('Commands to configure source-vault of disk in update-parameters file.'));
  setparametersUpdateDisksSourceVault0.command('set')
  ...
  var catparametersUpdateDisksSourceVault1 = cli.category('disk');
  var parametersUpdateDisksSourceVault1 = catparametersUpdateDisksSourceVault1.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersUpdateDisksSourceVault1 = parametersUpdateDisksSourceVault1.category('source-vault')
  .description($('Commands to configure source-vault of disk in update-parameters file.'));
  deleteparametersUpdateDisksSourceVault1.command('delete')
  ...
  var catparametersUpdateDisksKeyEncryptionKey0 = cli.category('disk');
  var parametersUpdateDisksKeyEncryptionKey0 = catparametersUpdateDisksKeyEncryptionKey0.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersUpdateDisksKeyEncryptionKey0 = parametersUpdateDisksKeyEncryptionKey0.category('key-encryption-key')
  .description($('Commands to configure key-encryption-key of disk in update-parameters file.'));
  setparametersUpdateDisksKeyEncryptionKey0.command('set')
  ...
  var catparametersUpdateDisksKeyEncryptionKey1 = cli.category('disk');
  var parametersUpdateDisksKeyEncryptionKey1 = catparametersUpdateDisksKeyEncryptionKey1.category('update-parameters')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersUpdateDisksKeyEncryptionKey1 = parametersUpdateDisksKeyEncryptionKey1.category('key-encryption-key')
  .description($('Commands to configure key-encryption-key of disk in update-parameters file.'));
  deleteparametersUpdateDisksKeyEncryptionKey1.command('delete')
