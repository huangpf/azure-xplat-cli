...
*/
  ...
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersCreateOrUpdateDisksSourceVault1ESkEKsV1 = parametersCreateOrUpdateDisksSourceVault1ESkEKsV1.category('key-encryption-key-source-vault')
...
*/
  ...
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersUpdateDisksSourceVault1ESkEKsV1 = parametersUpdateDisksSourceVault1ESkEKsV1.category('key-encryption-key-source-vault')
