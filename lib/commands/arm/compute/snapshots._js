...
azure snapshot config snapshot set
--parameter-file $f
--parse
...
azure snapshot config snapshot delete
--parameter-file $f
--account-type
--time-created
--os-type
...
azure snapshot config creation-data set
--parameter-file $f
--parse
...
azure snapshot config creation-data delete
--parameter-file $f
--create-option
--storage-account-id
--image-reference
...
azure snapshot config image-reference set
--parameter-file $f
--parse
--id $id
--lun $lun

azure snapshot config image-reference delete
--parameter-file $f
--id
--lun

azure snapshot config encryption-settings set
--parameter-file $f
--parse
--enabled $enabled
...
azure snapshot config encryption-settings delete
--parameter-file $f
--enabled
--disk-encryption-key
--key-encryption-key

azure snapshot config disk-encryption-key set
--parameter-file $f
--parse
--source-vault $sourceVault
--secret-url $secretUrl

azure snapshot config disk-encryption-key delete
--parameter-file $f
--source-vault
--secret-url

azure snapshot config source-vault set
--parameter-file $f
--parse
--id $id

azure snapshot config source-vault delete
--parameter-file $f
--id

azure snapshot config key-encryption-key set
--parameter-file $f
--parse
--source-vault $sourceVault
--key-url $keyUrl

azure snapshot config key-encryption-key delete
--parameter-file $f
--source-vault
--key-url
...
azure snapshot config generate 
--parameter-file $f

azure snapshot config patch 
--parameter-file $f

azure snapshot delete 
--resource-group $p0
--name $p1
...
azure snapshot grant-access-parameters grant-access-data set
--parameter-file $f
--parse
--access $access
--duration-in-seconds $durationInSeconds

azure snapshot grant-access-parameters grant-access-data delete
--parameter-file $f
--access
--duration-in-seconds

azure snapshot grant-access 
--resource-group $p0
--name $p1
...
azure snapshot list-by-resource-group 
--resource-group $p0

azure snapshot revoke-access 
--resource-group $p0
--name $p1

azure snapshot update-parameters snapshot-update set
--parameter-file $f
--parse
--account-type $accountType
--os-type $osType
...
azure snapshot update-parameters snapshot-update delete
--parameter-file $f
--account-type
--os-type
--creation-data
...
azure snapshot update-parameters creation-data set
--parameter-file $f
--parse
--create-option $createOption
--storage-account-id $storageAccountId
...
azure snapshot update-parameters creation-data delete
--parameter-file $f
--create-option
--storage-account-id
--image-reference
...
azure snapshot update-parameters image-reference set
--parameter-file $f
--parse
--id $id
--lun $lun

azure snapshot update-parameters image-reference delete
--parameter-file $f
--id
--lun

azure snapshot update-parameters encryption-settings set
--parameter-file $f
--parse
--enabled $enabled
--disk-encryption-key $diskEncryptionKey
...
azure snapshot update-parameters encryption-settings delete
--parameter-file $f
--enabled
--disk-encryption-key
--key-encryption-key

azure snapshot update-parameters disk-encryption-key set
--parameter-file $f
--parse
--source-vault $sourceVault
--secret-url $secretUrl

azure snapshot update-parameters disk-encryption-key delete
--parameter-file $f
--source-vault
--secret-url

azure snapshot update-parameters source-vault set
--parameter-file $f
--parse
--id $id

azure snapshot update-parameters source-vault delete
--parameter-file $f
--id

azure snapshot update-parameters key-encryption-key set
--parameter-file $f
--parse
--source-vault $sourceVault
--key-url $keyUrl

azure snapshot update-parameters key-encryption-key delete
--parameter-file $f
--source-vault
--key-url
...
azure snapshot update 
--resource-group $p0
--name $p1
--snapshot $p2
--parameter-file $f

azure snapshot update-parameters generate 
--parameter-file $f

azure snapshot update-parameters patch 
--parameter-file $f
...
*/
  var snapshotsCreateOrUpdate = cli.category('snapshot')
  ...
  //config set snapshot
  var catparametersCreateOrUpdateSnapshotsSnapshot0 = cli.category('snapshot');
  ...
  .description($('Commands to configure snapshot of snapshot in config file.'));
  ...
  var catparametersCreateOrUpdateSnapshotsSnapshot1 = cli.category('snapshot');
  ...
  var catparametersCreateOrUpdateSnapshotsCreationData0 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsCreationData0 = catparametersCreateOrUpdateSnapshotsCreationData0.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersCreateOrUpdateSnapshotsCreationData0 = parametersCreateOrUpdateSnapshotsCreationData0.category('creation-data')
  .description($('Commands to configure creation-data of snapshot in config file.'));
  setparametersCreateOrUpdateSnapshotsCreationData0.command('set')
  ...
  var catparametersCreateOrUpdateSnapshotsCreationData1 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsCreationData1 = catparametersCreateOrUpdateSnapshotsCreationData1.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersCreateOrUpdateSnapshotsCreationData1 = parametersCreateOrUpdateSnapshotsCreationData1.category('creation-data')
  .description($('Commands to configure creation-data of snapshot in config file.'));
  deleteparametersCreateOrUpdateSnapshotsCreationData1.command('delete')
  ...
  var catparametersCreateOrUpdateSnapshotsImageReference0 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsImageReference0 = catparametersCreateOrUpdateSnapshotsImageReference0.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersCreateOrUpdateSnapshotsImageReference0 = parametersCreateOrUpdateSnapshotsImageReference0.category('image-reference')
  .description($('Commands to configure image-reference of snapshot in config file.'));
  setparametersCreateOrUpdateSnapshotsImageReference0.command('set')
  ...
  var catparametersCreateOrUpdateSnapshotsImageReference1 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsImageReference1 = catparametersCreateOrUpdateSnapshotsImageReference1.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersCreateOrUpdateSnapshotsImageReference1 = parametersCreateOrUpdateSnapshotsImageReference1.category('image-reference')
  .description($('Commands to configure image-reference of snapshot in config file.'));
  deleteparametersCreateOrUpdateSnapshotsImageReference1.command('delete')
  ...
  var catparametersCreateOrUpdateSnapshotsEncryptionSettings0 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsEncryptionSettings0 = catparametersCreateOrUpdateSnapshotsEncryptionSettings0.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersCreateOrUpdateSnapshotsEncryptionSettings0 = parametersCreateOrUpdateSnapshotsEncryptionSettings0.category('encryption-settings')
  .description($('Commands to configure encryption-settings of snapshot in config file.'));
  setparametersCreateOrUpdateSnapshotsEncryptionSettings0.command('set')
  ...
  var catparametersCreateOrUpdateSnapshotsEncryptionSettings1 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsEncryptionSettings1 = catparametersCreateOrUpdateSnapshotsEncryptionSettings1.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersCreateOrUpdateSnapshotsEncryptionSettings1 = parametersCreateOrUpdateSnapshotsEncryptionSettings1.category('encryption-settings')
  .description($('Commands to configure encryption-settings of snapshot in config file.'));
  deleteparametersCreateOrUpdateSnapshotsEncryptionSettings1.command('delete')
  ...
  var catparametersCreateOrUpdateSnapshotsDiskEncryptionKey0 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsDiskEncryptionKey0 = catparametersCreateOrUpdateSnapshotsDiskEncryptionKey0.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersCreateOrUpdateSnapshotsDiskEncryptionKey0 = parametersCreateOrUpdateSnapshotsDiskEncryptionKey0.category('disk-encryption-key')
  .description($('Commands to configure disk-encryption-key of snapshot in config file.'));
  setparametersCreateOrUpdateSnapshotsDiskEncryptionKey0.command('set')
  ...
  var catparametersCreateOrUpdateSnapshotsDiskEncryptionKey1 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsDiskEncryptionKey1 = catparametersCreateOrUpdateSnapshotsDiskEncryptionKey1.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersCreateOrUpdateSnapshotsDiskEncryptionKey1 = parametersCreateOrUpdateSnapshotsDiskEncryptionKey1.category('disk-encryption-key')
  .description($('Commands to configure disk-encryption-key of snapshot in config file.'));
  deleteparametersCreateOrUpdateSnapshotsDiskEncryptionKey1.command('delete')
  ...
  var catparametersCreateOrUpdateSnapshotsSourceVault0 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsSourceVault0 = catparametersCreateOrUpdateSnapshotsSourceVault0.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersCreateOrUpdateSnapshotsSourceVault0 = parametersCreateOrUpdateSnapshotsSourceVault0.category('source-vault')
  .description($('Commands to configure source-vault of snapshot in config file.'));
  setparametersCreateOrUpdateSnapshotsSourceVault0.command('set')
  ...
  var catparametersCreateOrUpdateSnapshotsSourceVault1 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsSourceVault1 = catparametersCreateOrUpdateSnapshotsSourceVault1.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersCreateOrUpdateSnapshotsSourceVault1 = parametersCreateOrUpdateSnapshotsSourceVault1.category('source-vault')
  .description($('Commands to configure source-vault of snapshot in config file.'));
  deleteparametersCreateOrUpdateSnapshotsSourceVault1.command('delete')
  ...
  var catparametersCreateOrUpdateSnapshotsKeyEncryptionKey0 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsKeyEncryptionKey0 = catparametersCreateOrUpdateSnapshotsKeyEncryptionKey0.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersCreateOrUpdateSnapshotsKeyEncryptionKey0 = parametersCreateOrUpdateSnapshotsKeyEncryptionKey0.category('key-encryption-key')
  .description($('Commands to configure key-encryption-key of snapshot in config file.'));
  setparametersCreateOrUpdateSnapshotsKeyEncryptionKey0.command('set')
  ...
  var catparametersCreateOrUpdateSnapshotsKeyEncryptionKey1 = cli.category('snapshot');
  var parametersCreateOrUpdateSnapshotsKeyEncryptionKey1 = catparametersCreateOrUpdateSnapshotsKeyEncryptionKey1.category('config')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersCreateOrUpdateSnapshotsKeyEncryptionKey1 = parametersCreateOrUpdateSnapshotsKeyEncryptionKey1.category('key-encryption-key')
  .description($('Commands to configure key-encryption-key of snapshot in config file.'));
  deleteparametersCreateOrUpdateSnapshotsKeyEncryptionKey1.command('delete')
...
/*
  ...
  --name
*/
  var snapshotsDelete = cli.category('snapshot')
  .description($('Commands to manage your snapshots.  '));
...
/*
  ...
  --name
*/
  var snapshotsGet = cli.category('snapshot')
  .description($('Commands to manage your snapshots.  '));
...
*/
  var snapshotsGrantAccess = cli.category('snapshot')
  .description($('Commands to manage your snapshots.  '));
  ...
  .execute(function(resourceGroup, name, grantAccessData, options, _) {
    ...
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.snapshots.grantAccess(resourceGroup, name, grantAccessData, _);
    if (result) {
      cli.output.json(result);
    }
  });
/*
  Snapshots List
*/
  var snapshotsList = cli.category('snapshot')
  .description($('Commands to manage your snapshots.  '));
  snapshotsList.command('list')
  ...
  .execute(function(options, _) {
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.snapshots.list(_);
    var nextPageLink = result.nextLink;
    while (nextPageLink) {
      var pageResult = computeManagementClient.snapshots.listNext(nextPageLink, _);
...
/*
  ...
  --resource-group
*/
  var snapshotsListByResourceGroup = cli.category('snapshot')
  .description($('Commands to manage your snapshots.  '));
  snapshotsListByResourceGroup.command('list-by-resource-group [resource-group]')
  ...
  .execute(function(resourceGroup, options, _) {
    ...
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.snapshots.listByResourceGroup(resourceGroup, _);
    var nextPageLink = result.nextLink;
    while (nextPageLink) {
...
/*
  ...
  --name
*/
  var snapshotsRevokeAccess = cli.category('snapshot')
  .description($('Commands to manage your snapshots.  '));
...
*/
  var snapshotsUpdate = cli.category('snapshot')
  .description($('Commands to manage your snapshots.  '));
  ...
  var catparametersUpdateSnapshotsSnapshotUpdate0 = cli.category('snapshot');
  ...
  .description($('Commands to configure snapshot-update of snapshot in update-parameters file.'));
  ...
  var catparametersUpdateSnapshotsSnapshotUpdate1 = cli.category('snapshot');
  ...
  var catparametersUpdateSnapshotsCreationData0 = cli.category('snapshot');
  var parametersUpdateSnapshotsCreationData0 = catparametersUpdateSnapshotsCreationData0.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersUpdateSnapshotsCreationData0 = parametersUpdateSnapshotsCreationData0.category('creation-data')
  .description($('Commands to configure creation-data of snapshot in update-parameters file.'));
  setparametersUpdateSnapshotsCreationData0.command('set')
  ...
  var catparametersUpdateSnapshotsCreationData1 = cli.category('snapshot');
  var parametersUpdateSnapshotsCreationData1 = catparametersUpdateSnapshotsCreationData1.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersUpdateSnapshotsCreationData1 = parametersUpdateSnapshotsCreationData1.category('creation-data')
  .description($('Commands to configure creation-data of snapshot in update-parameters file.'));
  deleteparametersUpdateSnapshotsCreationData1.command('delete')
  ...
  var catparametersUpdateSnapshotsImageReference0 = cli.category('snapshot');
  var parametersUpdateSnapshotsImageReference0 = catparametersUpdateSnapshotsImageReference0.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersUpdateSnapshotsImageReference0 = parametersUpdateSnapshotsImageReference0.category('image-reference')
  .description($('Commands to configure image-reference of snapshot in update-parameters file.'));
  setparametersUpdateSnapshotsImageReference0.command('set')
  ...
  var catparametersUpdateSnapshotsImageReference1 = cli.category('snapshot');
  var parametersUpdateSnapshotsImageReference1 = catparametersUpdateSnapshotsImageReference1.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersUpdateSnapshotsImageReference1 = parametersUpdateSnapshotsImageReference1.category('image-reference')
  .description($('Commands to configure image-reference of snapshot in update-parameters file.'));
  deleteparametersUpdateSnapshotsImageReference1.command('delete')
  ...
  var catparametersUpdateSnapshotsEncryptionSettings0 = cli.category('snapshot');
  var parametersUpdateSnapshotsEncryptionSettings0 = catparametersUpdateSnapshotsEncryptionSettings0.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersUpdateSnapshotsEncryptionSettings0 = parametersUpdateSnapshotsEncryptionSettings0.category('encryption-settings')
  .description($('Commands to configure encryption-settings of snapshot in update-parameters file.'));
  setparametersUpdateSnapshotsEncryptionSettings0.command('set')
  ...
  var catparametersUpdateSnapshotsEncryptionSettings1 = cli.category('snapshot');
  var parametersUpdateSnapshotsEncryptionSettings1 = catparametersUpdateSnapshotsEncryptionSettings1.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersUpdateSnapshotsEncryptionSettings1 = parametersUpdateSnapshotsEncryptionSettings1.category('encryption-settings')
  .description($('Commands to configure encryption-settings of snapshot in update-parameters file.'));
  deleteparametersUpdateSnapshotsEncryptionSettings1.command('delete')
  ...
  var catparametersUpdateSnapshotsDiskEncryptionKey0 = cli.category('snapshot');
  var parametersUpdateSnapshotsDiskEncryptionKey0 = catparametersUpdateSnapshotsDiskEncryptionKey0.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersUpdateSnapshotsDiskEncryptionKey0 = parametersUpdateSnapshotsDiskEncryptionKey0.category('disk-encryption-key')
  .description($('Commands to configure disk-encryption-key of snapshot in update-parameters file.'));
  setparametersUpdateSnapshotsDiskEncryptionKey0.command('set')
  ...
  var catparametersUpdateSnapshotsDiskEncryptionKey1 = cli.category('snapshot');
  var parametersUpdateSnapshotsDiskEncryptionKey1 = catparametersUpdateSnapshotsDiskEncryptionKey1.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersUpdateSnapshotsDiskEncryptionKey1 = parametersUpdateSnapshotsDiskEncryptionKey1.category('disk-encryption-key')
  .description($('Commands to configure disk-encryption-key of snapshot in update-parameters file.'));
  deleteparametersUpdateSnapshotsDiskEncryptionKey1.command('delete')
  ...
  var catparametersUpdateSnapshotsSourceVault0 = cli.category('snapshot');
  var parametersUpdateSnapshotsSourceVault0 = catparametersUpdateSnapshotsSourceVault0.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersUpdateSnapshotsSourceVault0 = parametersUpdateSnapshotsSourceVault0.category('source-vault')
  .description($('Commands to configure source-vault of snapshot in update-parameters file.'));
  setparametersUpdateSnapshotsSourceVault0.command('set')
  ...
  var catparametersUpdateSnapshotsSourceVault1 = cli.category('snapshot');
  var parametersUpdateSnapshotsSourceVault1 = catparametersUpdateSnapshotsSourceVault1.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersUpdateSnapshotsSourceVault1 = parametersUpdateSnapshotsSourceVault1.category('source-vault')
  .description($('Commands to configure source-vault of snapshot in update-parameters file.'));
  deleteparametersUpdateSnapshotsSourceVault1.command('delete')
  ...
  var catparametersUpdateSnapshotsKeyEncryptionKey0 = cli.category('snapshot');
  var parametersUpdateSnapshotsKeyEncryptionKey0 = catparametersUpdateSnapshotsKeyEncryptionKey0.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var setparametersUpdateSnapshotsKeyEncryptionKey0 = parametersUpdateSnapshotsKeyEncryptionKey0.category('key-encryption-key')
  .description($('Commands to configure key-encryption-key of snapshot in update-parameters file.'));
  setparametersUpdateSnapshotsKeyEncryptionKey0.command('set')
  ...
  var catparametersUpdateSnapshotsKeyEncryptionKey1 = cli.category('snapshot');
  var parametersUpdateSnapshotsKeyEncryptionKey1 = catparametersUpdateSnapshotsKeyEncryptionKey1.category('update-parameters')
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersUpdateSnapshotsKeyEncryptionKey1 = parametersUpdateSnapshotsKeyEncryptionKey1.category('key-encryption-key')
  .description($('Commands to configure key-encryption-key of snapshot in update-parameters file.'));
  deleteparametersUpdateSnapshotsKeyEncryptionKey1.command('delete')
