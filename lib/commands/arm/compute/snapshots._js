...
*/
  ...
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersCreateOrUpdateSnapshotsSourceVault1ESkEKsV1 = parametersCreateOrUpdateSnapshotsSourceVault1ESkEKsV1.category('key-encryption-key-source-vault')
...
*/
  ...
  .description($('Commands to manage configuration of snapshots in the parameter file.'));
  var deleteparametersUpdateSnapshotsSourceVault1ESkEKsV1 = parametersUpdateSnapshotsSourceVault1ESkEKsV1.category('key-encryption-key-source-vault')
