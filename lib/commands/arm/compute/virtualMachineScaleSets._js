...
*/
  ...
  .description($('Commands to manage configuration of virtual-machine-scale-sets in the parameter file.'));
  var deleteparametersCreateOrUpdateVirtualMachineScaleSetsManagedDisk1VMPsPdDDImD1 = parametersCreateOrUpdateVirtualMachineScaleSetsManagedDisk1VMPsPdDDImD1.category('data-disks-managed-disk')
