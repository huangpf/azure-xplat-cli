...
*/
  ...
  .execute(function(resourceGroupName, options, _) {
    ...
    while (nextPageLink) {
      var pageResult = computeManagementClient.virtualMachineScaleSets.listNext(_);
...
*/
  ...
  .execute(function(options, _) {
    ...
    var nextPageLink = result.nextPageLink;
    while (nextPageLink) {
      var pageResult = computeManagementClient.virtualMachineScaleSets.listAllNext(_);
      pageResult.forEach(function(item) {
        result.push(item);
      });
      nextPageLink = pageResult.nextPageLink;
...
*/
  ...
  .execute(function(resourceGroupName, vMScaleSetName, options, _) {
    ...
    var nextPageLink = result.nextPageLink;
    while (nextPageLink) {
      var pageResult = computeManagementClient.virtualMachineScaleSets.listSkusNext(_);
      pageResult.forEach(function(item) {
        result.push(item);
      });
      nextPageLink = pageResult.nextPageLink;
...
*/
  ...
  .execute(function(resourceGroupName, virtualMachineScaleSetName, odataQuery, select, options, _) {
    ...
    var nextPageLink = result.nextPageLink;
    while (nextPageLink) {
      var pageResult = computeManagementClient.virtualMachineScaleSetVMs.listNext(_);
      pageResult.forEach(function(item) {
        result.push(item);
      });
      nextPageLink = pageResult.nextPageLink;
