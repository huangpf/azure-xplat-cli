...
--availability-set-name $p1
--parameter-file $f

azure container config container-service set
--parameter-file $f
--parse
...
azure container config container-service delete
--parameter-file $f
--provisioning-state
...
azure container config orchestrator-profile set
--parameter-file $f
--parse
--orchestrator-type $orchestratorType

azure container config orchestrator-profile delete
--parameter-file $f
--orchestrator-type

azure container config master-profile set
--parameter-file $f
--parse
--count $count
...
azure container config master-profile delete
--parameter-file $f
--count
--dns-prefix
--fqdn

azure container config agent-pool-profiles set
--parameter-file $f
--index $i
--value $v
--parse
...
azure container config agent-pool-profiles delete
--parameter-file $f
--index $pindex
--name
--count
...
azure container config windows-profile set
--parameter-file $f
--parse
--admin-username $adminUsername
--admin-password $adminPassword

azure container config windows-profile delete
--parameter-file $f
--admin-username
--admin-password

azure container config linux-profile set
--parameter-file $f
--parse
--admin-username $adminUsername
--ssh $ssh

azure container config linux-profile delete
--parameter-file $f
--admin-username
--ssh

azure container config ssh set
--parameter-file $f
--parse
--public-keys $publicKeys

azure container config ssh delete
--parameter-file $f
--public-keys

azure container config public-keys set
--parameter-file $f
--index $i
--value $v
--parse
...
azure container config public-keys delete
--parameter-file $f
--index $pindex
--key-data

azure container config diagnostics-profile set
--parameter-file $f
--parse
--vm-diagnostics $vmDiagnostics

azure container config diagnostics-profile delete
--parameter-file $f
--vm-diagnostics

azure container config vm-diagnostics set
--parameter-file $f
--parse
--enabled $enabled
--storage-uri $storageUri

azure container config vm-diagnostics delete
--parameter-file $f
--enabled
--storage-uri

azure container create-or-update 
--resource-group-name $p0
--container-service-name $p1
--parameters $p2
--parameter-file $f

azure container config generate 
--parameter-file $f

azure container config patch 
--parameter-file $f
...
azure container list-by-resource-group 
--resource-group-name $p0
--parameter-file $f
...
*/
  ...
  availabilitySetsListAvailableSizes.command('list-available-sizes [resource-group-name] [availability-set-name]')
  ...
  .usage('[options] <resource-group-name> <availability-set-name>')
  .option('-g, --resource-group-name <resource-group-name>', $('resource-group-name'))
  .option('--availability-set-name <availability-set-name>', $('availability-set-name'))
  .option('--parameter-file <parameter-file>', $('the input parameter file'))
  .option('-s, --subscription <subscription>', $('the subscription identifier'))
  .execute(function(resourceGroupName, availabilitySetName, options, _) {
    ...
    if (!availabilitySetName) {
      availabilitySetName = cli.interaction.promptIfNotGiven($('availability-set-name : '), availabilitySetName, _);
    }

    cli.output.verbose('availabilitySetName = ' + availabilitySetName);
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.availabilitySets.listAvailableSizes(resourceGroupName, availabilitySetName, _);
    if (result) {
...
*/
  var containerServiceCreateOrUpdate = cli.category('container')
  .description($('Commands to manage your container service.  '));
  containerServiceCreateOrUpdate.command('create-or-update [resource-group-name] [container-service-name] [parameters]')
  .description($('The operation to create or update a container service.'))
  .usage('[options] <resource-group-name> <container-service-name> <parameters>')
  .option('-g, --resource-group-name <resource-group-name>', $('resource-group-name'))
  .option('--container-service-name <container-service-name>', $('container-service-name'))
  .option('-p, --parameters <parameters>', $('parameters'))
  .option('--parameter-file <parameter-file>', $('the input parameter file'))
  .option('-s, --subscription <subscription>', $('the subscription identifier'))
  .execute(function(resourceGroupName, containerServiceName, parameters, options, _) {
    if (!resourceGroupName) {
      resourceGroupName = cli.interaction.promptIfNotGiven($('resource-group-name : '), resourceGroupName, _);
    }
    ...
    if (!containerServiceName) {
      containerServiceName = cli.interaction.promptIfNotGiven($('container-service-name : '), containerServiceName, _);
    }

    cli.output.verbose('containerServiceName = ' + containerServiceName);
    ...
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.containerServiceOperations.createOrUpdate(resourceGroupName, containerServiceName, parametersObj, _);
    if (result) {
      cli.output.json(result);
    }
  });
  ...
  containerServiceCreateOrUpdatecreateOrUpdateParameters2.command('generate')
  ...
  var catparametersCreateOrUpdateContainerServiceContainerService0 = cli.category('container');
  ...
  .description($('Commands to set components of container-service in config file.'));
  ...
  var catparametersCreateOrUpdateContainerServiceContainerService1 = cli.category('container');
  ...
  .description($('Commands to delete components of container-service in config file.'));
  ...
  var catparametersCreateOrUpdateContainerServiceOrchestratorProfile0 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceOrchestratorProfile1 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceMasterProfile0 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceMasterProfile1 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceAgentPoolProfiles0 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceAgentPoolProfiles1 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceWindowsProfile0 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceWindowsProfile1 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceLinuxProfile0 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceLinuxProfile1 = cli.category('container');
  ...
  //config set ssh
  var catparametersCreateOrUpdateContainerServiceSsh0 = cli.category('container');
  ...
  //config delete ssh
  var catparametersCreateOrUpdateContainerServiceSsh1 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServicePublicKeys0 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServicePublicKeys1 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceDiagnosticsProfile0 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceDiagnosticsProfile1 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceVmDiagnostics0 = cli.category('container');
  ...
  var catparametersCreateOrUpdateContainerServiceVmDiagnostics1 = cli.category('container');
...
/*
  ...
  --container-service-name
*/
  var containerServiceDelete = cli.category('container')
  .description($('Commands to manage your container service.  '));
  containerServiceDelete.command('delete [resource-group-name] [container-service-name]')
  .description($('The operation to delete a container service.'))
  .usage('[options] <resource-group-name> <container-service-name>')
  .option('-g, --resource-group-name <resource-group-name>', $('resource-group-name'))
  .option('--container-service-name <container-service-name>', $('container-service-name'))
  .option('--parameter-file <parameter-file>', $('the input parameter file'))
  .option('-s, --subscription <subscription>', $('the subscription identifier'))
  .execute(function(resourceGroupName, containerServiceName, options, _) {
    if (!resourceGroupName) {
      resourceGroupName = cli.interaction.promptIfNotGiven($('resource-group-name : '), resourceGroupName, _);
    }
    ...
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.containerServiceOperations.deleteMethod(resourceGroupName, containerServiceName, _);
    if (result) {
      cli.output.json(result);
    }
  });
/*
  ...
  --container-service-name
*/
  var containerServiceGet = cli.category('container')
  .description($('Commands to manage your container service.  '));
  containerServiceGet.command('get [resource-group-name] [container-service-name]')
  ...
  .execute(function(resourceGroupName, containerServiceName, options, _) {
    ...
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.containerServiceOperations.get(resourceGroupName, containerServiceName, _);
...
/*
  ContainerService ListByResourceGroup
  --resource-group-name
*/
  var containerServiceListByResourceGroup = cli.category('container')
  .description($('Commands to manage your container service.  '));
  containerServiceListByResourceGroup.command('list-by-resource-group [resource-group-name]')
  ...
  .execute(function(resourceGroupName, options, _) {
    ...
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.containerServiceOperations.listByResourceGroup(resourceGroupName, _);
    if (result) {
      cli.output.json(result);
    }
  });
