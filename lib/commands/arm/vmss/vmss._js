...
exports.init = function (cli) {
  ...
  .execute(function (resourceGroupName, name, location, imageUrn, adminUsername, adminPassword, options, _) {
    ...
    var getLinuxConfiguration = functions (adminUsername, adminPassword, sshPublickeyFile) {
    ...
    var parametersObj = {
      ...
      virtualMachineProfile : {
        ...
        oSProfile : {
          ...
          linuxConfiguration : getLinuxConfiguration(options.adminPassword, options.sshPublickeyFile);
        },
        storageProfile : {
          imageReference : {
